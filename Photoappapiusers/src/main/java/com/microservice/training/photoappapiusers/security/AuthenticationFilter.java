...
import com.microservice.training.photoappapiusers.ui.model.LoginRequestModel;
	...
	public AuthenticationFilter(UserService usersService, 
	 ...
	 @Override
	    ...
	    protected void successfulAuthentication(HttpServletRequest req,
			  ...
			  userDetails = usersService.getUserDetailsByEmail(userName);
			  System.out.println("Expiration Time"+Long.parseLong(environment.getProperty("token.expiration_time")));
